  ...
  <b-row class="pt-4">
    <b-col cols='5'>
      ...
      <b-list-group class="mb-3">
        <b-list-group-item><b>Username:</b> {{userData.username}}</b-list-group-item>
        <b-list-group-item><b>Email:</b> {{userData.email}}</b-list-group-item>
        <b-list-group-item><b>Products on sale:</b> {{userData.products.length}}</b-list-group-item>
      </b-list-group>
      <!-- User information -->
      <b-button v-if="isOwner"
      @click='toggleEdit'
      block pill variant='outline-info'
      :pressed='isEditing'
      >Edit</b-button>
    ...
    <b-col cols='7'>
      ...
      <b-list-group>
        <b-list-group-item v-for="product in userData.products" :key='product._id'>
